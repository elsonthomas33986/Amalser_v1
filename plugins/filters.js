...
const array = ['ho','she','ra','mu','hot','ta','Cr7','uyir','power','va','wow','se','no','nanba','sebin','messi','maman','pha','oi','cha','muth','kiss','dey','ga','player','king','kayari','aliya','nari','omban','Hii','Da','sad','nee','myre','mood','bg','chunk','ser','kundan','sir','My','myr','umbi','bot','poda','git','alive','owner','neymar','list','help','oii','on','one','vanne','vannu','kozhi','set','Fuck','love','broke','ohoo','Bye','pne','left','Amal','don','onn','stop','setta','entry','muth','Hi','chaya','maaripoyi','vibe','milk','feeling','thendi','nannayi','saramilla','gun','terror','pne','poi','remix','begging','dance','enjoy','pwolikada','nallath','power','finish','palasaji','thepp','pokko','kunda','thaa','sry','muthmani','miko','smart','kili','bass','vada','escape','number','moon','bella','sherikum','spider','robo','thyr','yeah','music','mindilla','mood','vishayam','mandan','tata','pwoli','messi','bye']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
...
const array = ['love','list','machu','menu','mute','onn','oo','so','unmute','wait','adi','army','bye','chaya','edit','ip','kayari','mari','money','monu','nallath','night','nyt','on','patti','po','poth','sir','Amal','Hii','ee','Da','food','Hlo','para','love u','set','sed','jada','amal','Hi','sad','don','Loki','bye','Cid','ennade','pode','sha','heppy','sry','lub','vishayam','maduth','pokko','look','bloody','hug','beautiful','room','sweety','wonderful','ishtama','No','stop','mottawilza','rich','Rex','thee','chance','dangerous','kill','venda','Op','heart','maranamass','vave','Kumman','waste','action','nice','Sexy','oombi','pever','vellam']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
